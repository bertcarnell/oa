...
${OBJECTDIR}/oa_r.o: oa_r.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I../../../../../../../Program\ Files/R/R-3.0.1/library/Rcpp/include -I../../../../../../../Program\ Files/R/R-3.0.1/include -I../oalib -I../../../boost -std=c++98 -mtune=core2 -Wall -pedantic -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/oa_r.o oa_r.cpp
...
${TESTDIR}/tests/oa_rTest.o: tests/oa_rTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -I../../../../../../../Program\ Files/R/R-3.0.1/library/Rcpp/include -I../../../../../../../Program\ Files/R/R-3.0.1/include -I../oalib -I../../../boost -I. -std=c++98 -mtune=core2 -Wall -pedantic -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/oa_rTest.o tests/oa_rTest.cpp
...
${OBJECTDIR}/oa_r_nomain.o: ${OBJECTDIR}/oa_r.o oa_r.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Werror -I../../../../../../../Program\ Files/R/R-3.0.1/library/Rcpp/include -I../../../../../../../Program\ Files/R/R-3.0.1/include -I../oalib -I../../../boost -std=c++98 -mtune=core2 -Wall -pedantic -O2  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/oa_r_nomain.o oa_r.cpp;\
	else  \
